import { Logger, WebSocketAdapter } from '@vision/common';
...
import { CLOSE_EVENT, CONNECTION_EVENT, ERROR_EVENT } from '@vision/websockets/constants';
import { MessageMappingProperties } from '@vision/websockets/gateway-metadata-explorer';
