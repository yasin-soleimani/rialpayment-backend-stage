...
import { PATH_METADATA, SHARED_MODULE_METADATA } from '@vision/common/constants';
/**
 * Makes the module single-scoped (not singleton).
 * In this case, Vision will always create a new instance of this particular module when it's imported by another one.
 */
