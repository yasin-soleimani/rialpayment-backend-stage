...
import { ROUTE_ARGS_METADATA } from '@vision/common/constants';
import { RouteParamtypes } from '@vision/common/enums/route-paramtypes.enum';
import { PipeTransform } from '@vision/common';
...
const createPipesRouteParamDecorator = (paramtype: RouteParamtypes) => (
  data?,
  ...pipes: (Type<PipeTransform> | PipeTransform)[]): ParameterDecorator => (target, key, index) => {
  const args =
    Reflect.getMetadata(ROUTE_ARGS_METADATA, target.constructor, key) || {};
...
export function Query(...pipes: (Type<PipeTransform> | PipeTransform)[]): any;
export function Query(property: string, ...pipes: (Type<PipeTransform> | PipeTransform) []): any;
export function Query(property?: string | (Type<PipeTransform> | PipeTransform), ...pipes: (Type<PipeTransform> | PipeTransform)[]) {
...
export function Body(...pipes: (Type<PipeTransform> | PipeTransform)[]): any;
export function Body(
  property: string, ...pipes: (Type<PipeTransform> | PipeTransform)[]): any;
export function Body(
  property?: string | (Type<PipeTransform> | PipeTransform), ...pipes: (Type<PipeTransform> | PipeTransform)[]) {
...
export function Param(...pipes: (Type<PipeTransform> | PipeTransform)[]): any;
export function Param(property: string, ...pipes: (Type<PipeTransform> | PipeTransform)[]): any;
export function Param(property?: string | (Type<PipeTransform> | PipeTransform), ...pipes: (Type<PipeTransform> | PipeTransform)[]) {
