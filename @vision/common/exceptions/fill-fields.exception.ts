...
export class FillFieldsException extends HttpException {
  constructor(message= 'تمامی فیلد ها را پرکنید', success = false) {
    super(
      createHttpExceptionBody(message, success, VisionStatus.fillFields),
      HttpStatus.OK,
    );
  }
}
