import { IVisionApplicationContext, OnModuleInit } from '@vision/common';
...
import { UnknownElementException } from '@vision/core/errors/exceptions/unknown-element.exception';
...
import { ModuleTokenFactory } from '@vision/core/injector/module-token-factory';

export class VisionApplicationContext implements IVisionApplicationContext {
  private readonly moduleTokenFactory = new ModuleTokenFactory();
  private contextModuleFixture: Partial<Module>;

  constructor(
    protected readonly container: VisionContainer,
  ...
  public select<T>(module: Type<T>): IVisionApplicationContext {
    ...
    return new VisionApplicationContext(this.container, scope, selectedModule);
  }
