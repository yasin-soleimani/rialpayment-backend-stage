import { Controller, DynamicModule, Injectable, VisionModule } from '@vision/common/interfaces';
import { Type } from '@vision/common/interfaces/type.interface';
import { isFunction, isNil, isString, isSymbol, isUndefined } from '@vision/common/utils/shared.utils';
import { RuntimeException } from '@vision/core/errors/exceptions/runtime.exception';
import { UnknownExportException } from '@vision/core/errors/exceptions/unknown-export.exception';
import { Reflector } from '@vision/core/services/reflector.service';
...
import { ExternalContextCreator } from '@vision/core/helpers/external-context-creator';
...
import { InstanceWrapper, VisionContainer } from '@vision/core/injector/container';
import { ModuleRef } from '@vision/core/injector/module-ref';
import { ModulesContainer } from '@vision/core/injector/modules-container';
import { HTTP_SERVER_REF } from '@vision/core/injector/tokens';
...
export class Module {
  ...
  public addCoreInjectables(container: VisionContainer) {
    this.addModuleRef();
  ...
  public addExternalContextCreator(container: VisionContainer) {
  ...
  public addModulesContainer(container: VisionContainer) {
